...
public enum Accion {
	...
	DEVOLVER_ALQUILER_CLIENTE("Devolver el alquiler del cliente"),
	DEVOLVER_ALQUILER_VEHICULO("Devolver el alquiler de un vehículo"),
	...
	MOSTRAR_ESTADITICAS_MENSUALES("Mostrar estadísticas mensuales");
